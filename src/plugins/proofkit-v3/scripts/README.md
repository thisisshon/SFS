...
2. `src/pages/review3.astro` route shim
3. `src/pages/reviewdash3.astro` route shim

Then set `PUBLIC_REVIEW_WORKER_URL_V3` and deploy the worker. `sync.mjs` prints this same
